    ...
    <div className="min-h-screen bg-background text-foreground pt-20">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 pt-10 pb-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Your data. Your rules.</h1>
        ...
        <div className="relative rounded-2xl border border-border/30 bg-background/80 shadow-2xl p-6 md:p-10">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <div className="space-y-8 text-foreground leading-relaxed">
              {/* 1. Applicability */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">1. Applicability & Consent</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">2. Information We Collect</h2>
                <div className="space-y-6 ml-11">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">2.2 Video Content</h3>
                    <p className="text-sm text-muted-foreground">
                      Projects can be <strong>local</strong> or <strong>cloud</strong>:
                    </p>
                    <ul className="space-y-1 text-sm text-muted-foreground ml-6 list-disc">
                      <li>Local projects keep media on your device (IndexedDB / disk).</li>
                      <li>Cloud projects store media securely on our Hetzner VPS for collaboration and access.</li>
                      <li>Project metadata (names, timelines, settings) is stored in Supabase.</li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold mb-2">2.3 Additional Details You May Provide</h3>
                    <p className="text-sm text-muted-foreground">
              ...
              {/* 3. Data Processing */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">3. How We Process Your Data</h2>
                <div className="space-y-6 ml-11">
                  <div>
                    <h3 className="text-lg font-semibold mb-2">3.1 Local Processing</h3>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">3.2 Account Management</h3>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">3.3 Cloud Collaboration</h3>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">3.4 How We Use Information</h3>
                    <ul className="space-y-1 text-sm text-muted-foreground ml-6 list-disc">
              ...
              {/* 4. Data Storage */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">4. Data Storage and Security</h2>
                <div className="space-y-6 ml-11">
                  <div>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">4.3 Enforcement & Safety</h3>
                    <p className="text-sm text-muted-foreground">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">5. Third-Party Services</h2>
                <div className="grid md:grid-cols-4 gap-3 mb-10 ml-6">
                  <div className="relative rounded-lg border border-border/30 bg-muted/5 p-4">
                    <GlowingEffect disabled={false} spread={28} proximity={48} glow borderWidth={1} />
                    <div className="flex items-center gap-2 mb-1">
                      <Server className="w-4 h-4 text-foreground/80" />
                      <span className="text-sm font-semibold">Hetzner VPS</span>
                    </div>
                    <p className="text-xs text-muted-foreground">Secure hosting for services and media storage.</p>
                  </div>
                  <div className="relative rounded-lg border border-border/30 bg-muted/5 p-4">
                    <GlowingEffect disabled={false} spread={28} proximity={48} glow borderWidth={1} />
                    <div className="flex items-center gap-2 mb-1">
                      <KeyRound className="w-4 h-4 text-foreground/80" />
                      <span className="text-sm font-semibold">Google OAuth</span>
                    </div>
                  ...
                  <div className="relative rounded-lg border border-border/30 bg-muted/5 p-4">
                    ...
                    <p className="text-xs text-muted-foreground">Stores account preferences and project metadata.</p>
                  </div>
                  <div className="relative rounded-lg border border-border/30 bg-muted/5 p-4">
                    <GlowingEffect disabled={false} spread={28} proximity={48} glow borderWidth={1} />
                    <div className="flex items-center gap-2 mb-1">
                      <BarChart3 className="w-4 h-4 text-foreground/80" />
                      <span className="text-sm font-semibold">Umami Analytics</span>
                    </div>
                    <p className="text-xs text-muted-foreground">Cookie-less, privacy-friendly usage analytics.</p>
                  </div>
                </div>
              </section>
              ...
              {/* 6. Your Rights */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">6. Your Privacy Rights</h2>
                <div className="space-y-4 ml-8 text-sm text-muted-foreground">
                  <p>You have complete control over your data. You can:</p>
                  <ul className="ml-6 list-disc space-y-2">
                    <li>
                      <strong className="text-foreground">Delete your account</strong>: remove your account and all
                      associated data anytime.
                    </li>
                    <li>
                      <strong className="text-foreground">Export your data</strong>: download your projects in a
                      portable format.
                    </li>
                    <li>
                      <strong className="text-foreground">Clear local storage</strong>: remove all locally saved
                      projects.
                    </li>
                    <li>
                      <strong className="text-foreground">Talk to a human</strong>: contact us anytime with privacy
                      concerns.
                    </li>
                  </ul>
                </div>
              ...
              {/* Updates */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">9. Privacy Policy Changes</h2>

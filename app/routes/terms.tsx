    ...
    <div className="min-h-screen bg-background text-foreground pt-20">
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20">
        <div className="relative rounded-2xl border border-border/30 bg-background/80 shadow-2xl p-6 md:p-10">
          <GlowingEffect disabled={false} spread={44} proximity={72} glow borderWidth={1} hoverBorderWidth={3} />
            ...
            <div className="space-y-8 text-foreground leading-relaxed">
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  ...
                  <p>
                    ...
                    the more protective mandatory terms prevail.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  ...
                  <p>
                    AI features may rely on third‑party model providers. Outputs can be inaccurate or unsafe if misused.
                    You are responsible for reviewing AI outputs before use or publication.
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">4. Your Content & Ownership</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                  ...
                  <p>
                    You represent that you have all necessary rights to your User Content and that it does not violate
                    applicable law or third‑party rights (including publicity, privacy, copyright, or trademark).
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">6. AI Features & Model Providers</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <ul className="list-disc ml-6 space-y-1">
                    <li>
                      Some features send prompts and/or snippets of User Content to third‑party AI providers to fulfill
                      your request.
                    </li>
                    <li>
                      Outputs are provided “as is” and may contain errors. Review AI outputs before use. Do not rely on
                      AI for safety‑critical or legal decisions.
                    </li>
                    <li>
                      You must comply with any additional usage rules required by model providers. We may throttle or
                      disable AI features to protect service quality.
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">7. Cloud Projects & Storage</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <ul className="list-disc ml-6 space-y-1">
                    <li>
                      Cloud projects are stored on secure infrastructure with access controls. Storage limits, rates,
                      and performance may apply.
                    </li>
                    <li>
                      Project sharing grants access to invited collaborators according to permissions you choose. You
                      are responsible for whom you invite.
                    </li>
                    <li>
                      Deleted projects may be temporarily recoverable from backups. We may permanently delete data after
                      a retention window or upon account closure.
                    </li>
                  </ul>
                </div>
              </section>
              ...
              {/* 8. Acceptable Use */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">8. Acceptable Use</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <ul className="list-disc ml-6 space-y-1">
                    <li>
                      No illegal content or activity, including IP infringement, harassment, exploitation, or privacy
                      violations.
                    </li>
                    <li>
                      No malware, bots that harm service integrity, excessive load, scraping that circumvents rate
                      limits, or attempts to reverse engineer the service.
                    </li>
                    <li>
                      No uploading of content that is sexually exploitative, hateful, violent, or otherwise violates
              ...
              {/* 9. Payments & Plans */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">9. Payments & Plans</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    Some features may require a paid plan. Prices, features, and billing periods will be presented at
                    checkout. Unless stated otherwise, subscriptions renew automatically until canceled. Taxes may
                    apply.
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">10. Termination & Suspension</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <ul className="list-disc ml-6 space-y-1">
                    <li>
                      We may suspend or terminate your access to the hosted service at any time, with or without cause,
                      including for violations of these Terms, risk, abuse, or legal compliance.
                    </li>
                    <li>
                      Upon termination, your license to access the hosted service ends. We may provide a reasonable
                      window to export projects where feasible.
                    </li>
                    <li>
                      Self‑hosted or open‑source use (if available) is governed by the applicable open‑source licenses
                      and is separate from hosted access.
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">11. Availability, Changes & Beta Features</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>
                    We may modify, suspend, or discontinue any feature at any time. Beta or experimental features are
                    provided “as is,” may be throttled, and can be removed without notice.
                  </p>
                </div>
              </section>
              ...
              {/* 18. Changes to Terms */}
              <section>
                <h2 className="text-2xl font-bold mb-4 pl-2">18. Changes to These Terms</h2>
                <div className="space-y-2 ml-8 text-sm text-muted-foreground">
                  <p>

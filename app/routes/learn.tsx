...
//     boxShadow: "0 10px 30px rgba(0, 0, 0, 0.25), inset 0 0 0 1px rgba(255, 255, 255, 0.06)",
//   };
...
//     color: "transparent",
//     // color: 'red',
//     backgroundImage: "linear-gradient(180deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.78) 100%)",
...
//       <h1 style={{ textAlign: "center", marginBottom: "2rem", color: "#333" }}>TikTok-Style Captions Demo</h1>
